...
$(document).ready(function () {
  ...
  var qs = function qs() {var el = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "";return document.querySelector(el);};
  var fromTo = function fromTo(from, to) {var prgrs = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;return from + (to - from) * prgrs;};
  var getCenter = function getCenter() {var line = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    return {
      x: (+line.getAttribute("x1") + +line.getAttribute("x2")) / 2,
      y: (+line.getAttribute("y1") + +line.getAttribute("y2")) / 2 };

  };
  var getScalePoint = function getScalePoint() {var obj = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};var onScene = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
    if (!onScene) {
  ...
  var transforms = {
    translate3D: function translate3D() {var x = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;var y = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;var z = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;var el = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : "px";
      return "translate3D(" + x + el + ", " + y + el + ", " + z + el + ")";
    },

    translate: function translate() {var x = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;var y = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;var el = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "px";
      return "translate(" + x + el + ", " + y + el + ")";
    },

    rotate3d: function rotate3d() {var x = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;var y = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;var z = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;var deg = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 0;
      return "rotate3d(" + x + ", " + y + ", " + z + ", " + deg + "deg)";
    },

    rotate: function rotate() {var deg = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
      return "rotate(" + deg + "deg)";
    },

    scale: function scale() {var x = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1;var y = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1;
      return "scale(" + x + ", " + y + ")";
    },

    perspective: function perspective() {var val = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;var el = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "px";
  ...
  var play = {
    ...
    animation: function animation() {var _this = this;
      if (this.off) {// animation when volume became 0
        ...
        if (this.offCurStep < step2 && this.offCurStep >= 0) {
          ...
          [volObj.crossLbRt, volObj.crossLtRb].forEach(function (el, index) {
            ...
            var dx = index == 0 ?
            easing.customSin(1 - _progress2, -3, 3, 1) :
            easing.customSin(1 - _progress2, -2, 2, 1);
            var dy = index == 0 ?
            easing.customSin(1 - _progress2, -2, 2, 1) :
            easing.customSin(1 - _progress2, 2, -2, 1);
...

      {
        ...
        var dxBig = void 0,dxSm = void 0,sclFactB = void 0,sclFactSm = void 0;
        ...
        [volObj.arcBigF, volObj.arcBigB].forEach(function (el) {
          ...
          el.setAttribute("transform",
          transforms.translate(_this.curPosBig.x + dxBig * amplitudeB, y, "") +
          transforms.scale(scale, scale));
        ...
        [volObj.arcSmF, volObj.arcSmB].forEach(function (el) {
          ...
          el.setAttribute("transform",
          transforms.translate(_this.curPosSm.x + dxSm * amplitudeS, y, "") +
          transforms.scale(scale, scale));
  ...
  var drag = {
    ...
    animateDrag: function animateDrag() {var _this2 = this;
      this.curCx += this.dx;
      var cx = this.curCx;
  ...
  // custom volume schtuff
$('#mySlider').on('change', (e)=>{ document.getElementById("myVideo").volume = $(this).val() })
